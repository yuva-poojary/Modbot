module.exports = class {
  ...
  async run () {
    ...
    if (!this.client.settings.has("default")) {
      if (!this.client.config.defaultSettings) throw new Error("defaultSettings not present in config.js or settings database. Bot cannot load.");
    ...
    this.client.user.setActivity("-help | KnightBot");
